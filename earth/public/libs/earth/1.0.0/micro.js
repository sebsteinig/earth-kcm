...
// resolve KCM experiment name based on selected Drake Passage, Falkland Plateau, Walvis Ridge and CO2 configuration:
function GetExpID(DPD,FPG,WR,CO2) {
    switch (true) {
      case DPD === 1400 && FPG === 1 && WR === 1000 && CO2 === 1200 : 
        var expid = "C51";
        break;
      case DPD === 1400 && FPG === 2 && WR === 1000 && CO2 === 1200 : 
        var expid = "C53";
        break;
      case DPD === 1400 && FPG === 3 && WR === 1000 && CO2 === 1200 : 
        var expid = "C54";
        break;
      case DPD === 1400 && FPG === 1 && WR === 1000 && CO2 === 600 : 
        var expid = "C61";
        break;
      case DPD === 1400 && FPG === 2 && WR === 1000 && CO2 === 600 : 
        var expid = "C63";
        break;
      case DPD === 1400 && FPG === 3 && WR === 1000 && CO2 === 600 : 
        var expid = "C64";
        break;
      case DPD === 1400 && FPG === 1 && WR === 200 && CO2 === 1200 : 
        var expid = "WI1";
        break;
      case DPD === 1400 && FPG === 2 && WR === 200 && CO2 === 1200 : 
        var expid = "WI2";
        break;
      case DPD === 1400 && FPG === 3 && WR === 200 && CO2 === 1200 : 
        var expid = "WI3";
        break;
      case DPD === 1400 && FPG === 1 && WR === 200 && CO2 === 600 : 
        var expid = "WI4";
        break;
      case DPD === 1400 && FPG === 2 && WR === 200 && CO2 === 600 : 
        var expid = "WI5";
        break;
      case DPD === 1400 && FPG === 3 && WR === 200 && CO2 === 600 : 
        var expid = "WI6";
        break;
      case DPD === 200 && FPG === 1 && WR === 1000 && CO2 === 1200 : 
        var expid = "DS1";
        break;
      case DPD === 200 && FPG === 2 && WR === 1000 && CO2 === 1200 : 
        var expid = "DS2";
        break;
      case DPD === 200 && FPG === 3 && WR === 1000 && CO2 === 1200 : 
        var expid = "DS3";
        break;
      case DPD === 200 && FPG === 1 && WR === 1000 && CO2 === 600 : 
        var expid = "DS4";
        break;
      case DPD === 200 && FPG === 2 && WR === 1000 && CO2 === 600 : 
        var expid = "DS5";
        break;
      case DPD === 200 && FPG === 3 && WR === 1000 && CO2 === 600 : 
        var expid = "DS6";
        break;
      case DPD === 200 && FPG === 1 && WR === 200 && CO2 === 1200 : 
        var expid = "WS1";
        break;
      case DPD === 200 && FPG === 2 && WR === 200 && CO2 === 1200 : 
        var expid = "WS2";
        break;
      case DPD === 200 && FPG === 3 && WR === 200 && CO2 === 1200 : 
        var expid = "WS3";
        break;
      case DPD === 200 && FPG === 1 && WR === 200 && CO2 === 600 : 
        var expid = "WS4";
        break;
      case DPD === 200 && FPG === 2 && WR === 200 && CO2 === 600 : 
        var expid = "WS5";
        break;
      case DPD === 200 && FPG === 3 && WR === 200 && CO2 === 600 : 
        var expid = "WS6";
        break;
      case DPD === 0 && FPG === 1 && WR === 1000 && CO2 === 1200 : 
        var expid = "DC1";
        break;
      case DPD === 0 && FPG === 2 && WR === 1000 && CO2 === 1200 : 
        var expid = "DC2";
        break;
      case DPD === 0 && FPG === 3 && WR === 1000 && CO2 === 1200 : 
        var expid = "DC3";
        break;
      case DPD === 0 && FPG === 1 && WR === 1000 && CO2 === 600 : 
        var expid = "DC4";
        break;
      case DPD === 0 && FPG === 2 && WR === 1000 && CO2 === 600 : 
        var expid = "DC5";
        break;
      case DPD === 0 && FPG === 3 && WR === 1000 && CO2 === 600 : 
        var expid = "DC6";
        break;
      case DPD === 0 && FPG === 1 && WR === 200 && CO2 === 1200 : 
        var expid = "WC1";
        break;
      case DPD === 0 && FPG === 2 && WR === 200 && CO2 === 1200 : 
        var expid = "WC2";
        break;
      case DPD === 0 && FPG === 3 && WR === 200 && CO2 === 1200 : 
        var expid = "WC3";
        break;
      case DPD === 0 && FPG === 1 && WR === 200 && CO2 === 600 : 
        var expid = "WC4";
        break;
      case DPD === 0 && FPG === 2 && WR === 200 && CO2 === 600 : 
        var expid = "WC5";
        break;
      case DPD === 0 && FPG === 3 && WR === 200 && CO2 === 600 : 
        var expid = "WC6";
        break;
      default :
        var expid = "999"
...
var µ = function() {
    ...
    var DEFAULT_CONFIG = "C53/ANN/ocean/depthz/0m/overlay=ocesal/orthographic=-1.88,-39.94,593";
    ...
    function parse(hash, projectionNames, overlayTypes) {
        ...
        //             1        2        3          4          5            6      7      8    9
//        var tokens = /^(C50|(\d{4})\/(\d{1,2})\/(\d{1,2})\/(\d{3,4})Z)\/(\w+)\/(\w+)\/(\w+)([\/].+)?/.exec(hash);
        // C53/ANN/wind/surface/level/orthographic=-353.80,4.06,310
        //               exp    seas  param   surf   lev  *
        var tokens = /^(\w+)\/(\w+)\/(\w+)\/(\w+)\/(\w+)([\/].+)?/.exec(hash);
//         console.log("hash: " + hash );
//         console.log("exp " + tokens[1] );
//         console.log("seas " + tokens[2] );
//         console.log("param " + tokens[3] );
//         console.log("surf " + tokens[4] );
//         console.log("lev " + tokens[5] );
//         console.log("* " + tokens[6] );
 ...
 //           var dir = attr.date === "C50" ? "C50" : attr.date + "/" + attr.hour + "Z";
//            var dir = attr.date === "C50" ? "C50" : attr.date + "/" + attr.hour;
            var dir = attr.date + "/" + attr.hour;
