            ...
            create: function(attr) {
                return buildProduct({
                    ...
                    scale: {
                        bounds: [0, 5],
                        gradient: function(v, a) {
                            return µ.extendedSinebowColor(Math.min(v, 5) / 5, a);
                        }
                    },
//                    particles: {velocityScale: 1/60000, maxIntensity: 17}
                    particles: {velocityScale: 1/20000, maxIntensity: 1}
                });
            }
        },
...
//                                return µ.isValue(u) && µ.isValue(v) ? [u, v] : null;
                    ...
                    particles: {velocityScale: 1/200, maxIntensity: 0.001}
                });
            }
        },
